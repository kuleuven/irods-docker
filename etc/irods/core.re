...
acCreateUserZoneCollections {
    # do not automatically create any directory
    # the script provisioning users in irods should handle creation of directories
}
...
acSetRescSchemeForCreate {
  msiSetNoDirectRescInp("vault1%vault2%vault3%vault4");
...
# This gets triggered on the wrong system
#   msi_update_unixfilesystem_resource_free_space(*leaf_resource);
}
